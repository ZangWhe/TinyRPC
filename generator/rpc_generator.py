...
def printHelp():
    print('=' * 100)
    print('Welcome to use RPC Generator, this is help document:\n')
    ...
    print('Usage:')
    print('rpc_generator.py -[options][target]\n')
    print('Options:')
    print('-h, --help')
    ...
    print('')
    print('For example:')
    print('rpc_generator.py -i order_server.proto -o ./')
...
def gen_conf_file():
    ...
    file.close()
    print('succ write to ' + out_file)
    print('End generate rpc conf file')
    print('=' * 100)
...
def generate_framework_code(): 
    ...
    interface_test_client_file_template = Template(open(generator_path + '/template/test_rpc_client.cc.template','r').read())
    ...
    print('End generate rpc framework code')
    print('=' * 100)
...
def generate_project():
    ...
    try:
        ...
        print('=' * 150)
        print("Begin to generate rpc server") 
        ...
        print('Succ generate rpc project')
        print('=' * 150)
    
    except Exception as e:
        print("Failed to generate rpc rpc server, err: " + str(e))
        print('=' * 150)

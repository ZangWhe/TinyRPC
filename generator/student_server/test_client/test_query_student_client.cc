...
void test_client(const std::string& addr) {
  ...
  NEWMESSAGE(::queryStudentRequest, request);
  NEWMESSAGE(::queryStudentResponse, response);
  ...
  CALLRPRC(addr, Order_Stub, query_student, controller, request, response, closure);

...
PATH_RPC = RPC
PATH_COMM = $(PATH_RPC)/common
PATH_NET = $(PATH_RPC)/net
PATH_TCP = $(PATH_RPC)/net/tcp
PATH_CODER = $(PATH_RPC)/net/coder
PATH_RPC_GLOBAL = $(PATH_RPC)/net/rpc
...
PATH_INSTALL_INC_RPC = $(PATH_INSTALL_INC_ROOT)/$(PATH_RPC_GLOBAL)
...
CXXFLAGS += -I./ -I$(PATH_RPC)	-I$(PATH_COMM) -I$(PATH_NET) -I$(PATH_TCP) -I$(PATH_CODER) -I$(PATH_RPC_GLOBAL)
...
RPC_OBJ := $(patsubst $(PATH_RPC_GLOBAL)/%.cc, $(PATH_OBJ)/%.o, $(wildcard $(PATH_RPC_GLOBAL)/*.cc))
...
install:
	mkdir -p $(PATH_INSTALL_INC_COMM) $(PATH_INSTALL_INC_NET) $(PATH_INSTALL_INC_TCP) $(PATH_INSTALL_INC_CODER) $(PATH_INSTALL_INC_RPC)\
		...
		&& cp $(PATH_RPC_GLOBAL)/*.h $(PATH_INSTALL_INC_RPC) \
